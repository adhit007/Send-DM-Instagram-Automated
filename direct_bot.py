...
my_username = '' # Enter Your Username Instagram
my_password = '' # Enter Your Password Instagram

# Instagram username list for DM:
usernames = ['',''] # Enter username target send message

# Messages:
messages = ['example 1','example 2', 'example 3'] # Enter Your Message Here
